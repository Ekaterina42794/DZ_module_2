...
В таком случае, если этот список будет изменён внутри функции, то на следующий вызов функции 
он останется в том же состоянии.
...
def print_params(a=0, b='string', c=False):
    print(a,b,c)
# принимает 3 параметра со значениями по умолчанию
# (например сейчас это: 0, 'string', False).
# Функция должна выводить эти параметры.
# Вызовите функцию print_params с разным количеством аргументов, включая вызов без аргументов.
...
print_params(b=25)  # 0 25 False
print_params(c=[1, 2, 3])  # 0 string [1, 2, 3]
print_params()  # 0 string False
print_params(1, '"e"', a)  # 1 "e" [10, 9, 8, 7, 6]
'''print_params(1, '"e"', *a)  # введено слишком много параметров'''
print_params(**c)  # 'a': 777, 'b':888,'c': 999 ключи должны совпадать

#2
values_list =[90,  'lol',0.01]
values_dict={'a':22,'b':1.01,'c':'"44"'}
print(values_list)
print(values_dict)
print_params(*values_list)  # 90 lol 0.01
print_params(**values_dict) # 22 1.01 "44"

#3
values_list_2=['lol',True]
print_params(*values_list_2, 42)# работает: lol True 42
#print_params(1,2,**values_dict(c)) # 22 1.01 "44"
