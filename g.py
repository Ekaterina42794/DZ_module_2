...
def is_contains(string_1, list_):
...
string_info(str(input("введите слово № 1: _ ")))
is_contains(string_1 = str(input("введите слово № 2: _ ")),list_ = list(input("введите список: _ ")))
#count_calls()
print(calls)'''
